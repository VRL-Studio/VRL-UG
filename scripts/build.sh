...
VRL_UG_JAVA_PROJECT_FOLDER=$HOME/EigeneApps/VRL-UG/VRL-UG

# position of ug build folder 
UG_BUILD_FOLDER=$HOME/installs/ug4/build_vrl

# VRL home folder
VRL_DIR="${HOME}/.vrl/0.4.3/default"

# path to the library produced by ug build
UG_LIB_FOLDER=$HOME/installs/ug4/lib
...
VRL_STUDIO_OPEN_SCRIPT=/Applications/VRL-Studio.app/Contents/MacOS/run.sh
##########################################################################################
